        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-8 items-center mb-20 border-t border-white/10 pt-16">
          ...
          <div className="md:col-span-4 relative aspect-[4/3] w-full border border-white/10 rounded-2xl overflow-hidden group">
            ...
            <div className="absolute inset-0 p-4 flex flex-col justify-between z-10">
              <span className="text-[8px] font-space text-white/50 tracking-wider">DEVOPS_INTEGRATION_PIPELINE // 100% OK</span>
              <span className="text-[8px] font-space text-accent-lime text-center uppercase font-bold tracking-widest bg-black/60 backdrop-blur-sm py-1.5 px-3 rounded-full border border-white/5 mx-auto">PIPELINE_STABLE: OK</span>
            </div>
          </div>
        </div>
